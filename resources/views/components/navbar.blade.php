      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a href="{{route('profile_index', ['profile' => Auth::user()->profile])}}" class="d-flex align-items-center gap-2 text-decoration-none text-black ms-2"><img src="https://picsum.photos/300/200" alt="" class="icon-drop"> {{Auth::user()->name}}
            </a></li>
